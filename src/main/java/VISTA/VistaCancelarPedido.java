 ...
 * @author francisco
 */
public class VistaCancelarPedido extends javax.swing.JFrame {

    /**
     * Creates new form VistaCancelarPedido
     */
    public VistaCancelarPedido() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ingrese el ID del pedido");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaCancelarPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaCancelarPedido().setVisible(true);
            }
        });
    }
